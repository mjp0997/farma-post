...
@section('content')
      ...
      <div class='col-md-7 mx-auto'>
         <div class='card'>
            <div class='card-header p-3'>
               <h6 class="mb-0">Cliente #{{ $client->id }}</h6>
            </div>
            ...
            <div class='card-body'>
               ...
               <div class='row'>
                  <div class='col-md'>
                     <span class='text-xs fw-bolder text-dark'>Cédula:</span>

                     <p class='fw-bold'>{{ $client->dni }}</p>
                  </div>

                  <div class='col-md'>
                     <span class='text-xs fw-bolder text-dark'>Teléfono:</span>

                     <p class='fw-bold'>{{ $client->phone }}</p>
                  </div>
               </div>

               <div class='row'>
                  <div class='col'>
                     <span class='text-xs fw-bolder text-dark'>Dirección:</span>
   ...
   >
      <div class="modal-dialog modal-dialog-centered" role="document">
         <form class="modal-content" method="POST" action="{{ url('/clients/stock/'.$client->id) }}">
            @csrf

            @method('PUT')

            <div class="modal-header align-items-center">
               <h5 class="modal-title" id="stockModalLabel">{{ $client->name }}</h5>
